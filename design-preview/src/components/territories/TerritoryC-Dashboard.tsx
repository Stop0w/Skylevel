        ...
        <div className="max-w-full px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <h1 className="text-2xl font-semibold text-neutral-50">Recruiter Dashboard</h1>
              <span className="text-sm text-neutral-400">Q4 2024</span>
            </div>
            <div className="flex items-center gap-2">
              <button
                onClick={() => setShowNotifications(!showNotifications)}
                className="relative p-2 text-neutral-400 hover:text-neutral-100 hover:bg-neutral-800 rounded"
              >
              ...
              <button className="p-2 text-neutral-400 hover:text-neutral-100 hover:bg-neutral-800 rounded">
                <Settings className="w-5 h-5" />
              </button>
              <button className="bg-primary-600 hover:bg-primary-700 text-neutral-50 font-medium py-2 px-4 rounded flex items-center gap-2">
