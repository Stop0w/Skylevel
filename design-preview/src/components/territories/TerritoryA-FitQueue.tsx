...
const TerritoryAFitQueue: React.FC = () => {
  ...
  const getFitScoreColor = (score: number) => {
    if (score >= 85) return 'bg-accent-500 text-white border-accent-600'
    if (score >= 70) return 'bg-green-500 text-white border-green-600'
                  ...
                  <div className="flex items-start gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <div className={`inline-flex items-center px-4 py-2 rounded-full text-lg font-bold border-2 ${getFitScoreColor(candidate.fitScore)}`}>
